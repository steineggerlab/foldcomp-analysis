...
// ./pulchra
//
// Slightly modified to print only file name and time with -v flag
...
int main(int argc, char **argv)
{
  ...
  struct timeb time0, time1;
    ...
    if (_VERBOSE) printf("%s\t%.3f\n", name, (real)0.001 * (1000. * (time1.time - time0.time) + (time1.millitm - time0.millitm)));
